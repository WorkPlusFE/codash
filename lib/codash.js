...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('invariant')) :
  typeof define === 'function' && define.amd ? define(['exports', 'invariant'], factory) :
  (factory((global.workplusCodash = {}),global.invariant));
  ...
  var Cordova = function () {
    ...
    createClass(Cordova, [{
      ...
      value: function handle(config) {
        var dispatchConfig = merge(this.defaultsConfig, config);
      ...
      value: function create(hook, action) {
        ...
        var options = deepMerge(this.defaultsConfig, { hook: hook, action: action, params: params }, extend);
        return function () {
  ...
  exports.bindBackEvent = bindBackEvent;
